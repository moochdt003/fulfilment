...
<div class="wrap"><div id="icon-tools" class="icon32"></div>
    ...
    <div class="logo_section_MOA">
        <img src="../wp-content/plugins/fulfilment/logo.png" alt="MOA" >
    ...
    <table width="100%" border="1" class="widefat main_fulfiment">
        ...
        <?php foreach ($fulfilments as $fulfilment) : ?>
            <tr>
                ...
                <td> <a href="#TB_inline?width=600&height=550&inlineId=modal-window-id-edit" class="thickbox">
...
<?php include_once("edit_fulfilment_modal.php"); ?>
